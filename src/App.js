...
// Posts de Instagram destacados
const ANTES_DESPUES = [];

const MARCAS = [
  { nombre: "Black+Decker", desc: "Hidrolavadora", color: "#1C3A56", logo: null },
  { nombre: "Karcher", desc: "Lava-aspiradora", color: "#9C7A3C", logo: null },
...
export default function ClienteApp() {
  ...
  const confirmarCita = async () => {
    ...
    // Verificación final: confirmar que el rango de tiempo sigue libre
